...
declare const thirdPartyExperience: z.ZodEnum<["CIMU_STREAM_MATCH"]>;
...
declare const streamMatchMessage: z.ZodIntersection<z.ZodDiscriminatedUnion<"kind", [z.ZodObject<{
...
type StreamMatchMessage = z.infer<typeof streamMatchMessage>;
declare const game: {
    readonly id: "CIMU_STREAM_MATCH";
    readonly url: "https://stream.342games.com";
    readonly name: "Stream Match";
...
export { type GameParams, type StreamMatchMessage, type ThirdPartyExperienceEnum, game, gameParams, streamMatchMessage, thirdPartyExperience };
